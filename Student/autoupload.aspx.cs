                ...
                if (work_upload.InputStream != null || work_upload.InputStream.Length < maxSize)
                {
                    ...
                    if (aid > 0)
                    {
                        if (!abll.ExistsCheck(aid))
                        {
                            ...
                            string OnlyFileName = cook.Snum.ToString() + "_" + afid.ToString() + "_" + RndTime;
                    ...
                    else
                    {
                        ...
                        amodel.Asid = asid;
                        amodel.Anum = cook.Snum.ToString();
                        amodel.Aname = HttpUtility.UrlDecode(cook.Sname);
                        amodel.Ayid = ayid;
                        amodel.Afid = afid;
                        amodel.Atype = atype;
                        ...
                        amodel.Adate = adate;
                        amodel.Aip = cook.LoginIp;
                        amodel.Ayear = cook.Syear;
                        amodel.Agrade = cook.Sgrade;
                        amodel.Aclass = cook.Sclass;
                        amodel.Aterm = cook.ThisTerm;
                        switch (atype)
                        {
                            case "doc":
                            case "ppt":
