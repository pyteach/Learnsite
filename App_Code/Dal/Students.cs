...
namespace LearnSite.DAL
{
	...
	public class Students
	{
        ...
        public void UpdateAllScore(int persscore, int persquiz, int perstscore, int perattitude, int persurvey, int Rhid)
        {
            ...
            strSql.Append("(Sscore+Sgscore+Spscore+Stxtform)*@persscore/100+Svscore*@persurvey/100+Squiz*@persquiz/100+Sattitude*@perattitude/100+Stscore*@perstscore/100+Sfscore+Schinese");
