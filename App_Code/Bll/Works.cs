	...
	public class Works
	{
       ...
       /// <returns></returns>
        ...
        public void SaveProject(string id)
        {
            ...
            //string RndTime = LearnSite.Common.WordProcess.GetRandomNum(3).ToString();
        ...
        public DataTable GetSbPage(int startIndex, int endIndex, int Wcid)
        {
            return dal.GetSbPage(startIndex, endIndex, Wcid);
        }
        /// <summary>
		/// 获得数据列表
		/// </summary>
