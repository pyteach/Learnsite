...
namespace LearnSite.Common
{
    ...
    public class WordProcess
    {
        ...
        public static string txtview(string txturl)
        {
            ...
            if (File.Exists(txtpath))
            {
                string strTemp = File.ReadAllText(txtpath, Encoding.GetEncoding("utf-8"));

                string shtm = Common.Template.txthtm();
                if (shtm != "")
                {
                    str = shtm.Replace("#txt#", strTemp);
                }
            }
            return str;
        }
        ...
        public static string SelectWriteTeaNew(string filetype, string downfilename, bool isflex,string htmname)
        {
            ...
            string url = "<br /><div style='text-align: center;font-size: 9pt; color:#333333;'>点击下载查看：<a href='" + mydown + "' target='_blank'>" + mydown + "</a> 大小：" + Filesize(downfilename) + "kb</div>";
            str = str + url;
            return str;//返回预览的html生成页面
        }
        /// <summary>
