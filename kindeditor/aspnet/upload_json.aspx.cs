...
public partial class kindeditor_aspnet_upload_json : System.Web.UI.Page
{
    ...
    public void UploadRequest()
    {
        ...
        string uploadType = "gif,jpg,jpeg,png,bmp,tif,tiff,svg,swf,flv,f4v,mp3,wav,wma,wmv,mid,avi,mpg,mp4,asf,rm,rmvb,doc,docx,xls,xlsx,ppt,pptx,htm,html,txt,zip,rar,gz,bz2,flv,psd,fla,e,chm,mht,sb,sb2,pdf";
